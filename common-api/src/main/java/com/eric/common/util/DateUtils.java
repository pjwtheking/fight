...
public class DateUtils {
    ...
    public static void main(String[] args) {
        ...
        if( DateUtils.minuteBetweenByDateStr (DateUtils.getDateByStrTime("201801111348","yyyyMMddHHmm"), DateUtils.getNow()) > 0){
            System.out.println(DateUtils.minuteBetweenByDateStr (DateUtils.getDateByStrTime("201801111348","yyyyMMddHHmm"), DateUtils.getNow()));
        }else{
            System.out.println("时间未结束");
        }
        
        System.out.println(DateUtils.secondBetweenByDateStr(DateUtils.getDateByStrTime("20180110150200","yyyyMMddHHmmss"), DateUtils.getNow()));
